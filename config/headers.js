module.exports = {
  ...
  titleTemplate: 'Get Schedule - Metro',
  defaultTitle: 'Metro',
  description: 'Search arrival, departure times for Metro stations',
  base: { href: '/' },

  meta: [
    { name: "description", content: "Search arrival and departure times for Metro stations" }
  ],
